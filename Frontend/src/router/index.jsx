...
const FavoritesPage = Lazy(
     () => import("../features/saves/pages/FavoritesPage.jsx"),
);
const ArchivePage = Lazy(
     () => import("../features/saves/pages/ArchivePage.jsx"),
);
const SaveDetailPage = Lazy(
     () => import("../features/saves/pages/SaveDetailPage.jsx"),
);
const EditSavePage = Lazy(
     () => import("../features/saves/pages/EditSavePage.jsx"),
);
const GraphPage = Lazy(() => import("../features/graph/pages/GraphPage"));
const ClustersPage = Lazy(
     () => import("../features/clusters/pages/ClustersPage"),
);
const CollectionPage = Lazy(
     () => import("../features/collections/pages/CollectionPage"),
);
const TagPage = Lazy(() => import("../features/tags/pages/TagPage"));
const SettingsPage = Lazy(() => import("../features/user/pages/SettingsPage"));
const ProfilePage = Lazy(
     () => import("../features/user/pages/ProfilePage.jsx"),
);
...
export const router = createBrowserRouter([
     {
          ...
          children: [
               ...
               { path: "saves/:id/edit", element: <EditSavePage /> },
